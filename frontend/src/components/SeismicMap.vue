...
const customMarkerIcon = L.icon({
  iconUrl: getIconUrl('marker'), // Points to src/assets/icons/marker.png
  iconSize: [48, 48],            // Size at which it will be painted [width, height]
  iconAnchor: [24, 48],          // Point of the icon that anchors to lat/lng (center-bottom)
...
const deleteCenter = async () => {
  ...
  try {
    // If the ID is a string (DB UUID), delete it from the server
