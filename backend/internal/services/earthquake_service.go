...
func (s *EarthquakeService) GetRecentEarthquakes() ([]models.Feature, error) {
...
func (s *EarthquakeService) GetFilteredEarthquakes(minMag float64, limit int) ([]models.Feature, error) {
